...
export default function SignUpPage({ onNext }) {
  ...
  const inputStyle = {
    width: "100%",
    background: "rgba(58, 74, 69, 0.8)",
    border: "1.5px solid #4a7a6a",
    borderRadius: 10,
    padding: "12px 14px",
    color: "#fff",
    fontSize: 14,
  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        input:focus { border-color: #4ecdc4 !important; background: rgba(58,74,69,0.95) !important; }
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 24 }}>
          ...
          <h1 style={{ margin: 0, fontSize: 26, fontWeight: 800, color: "#f5deb3", letterSpacing: -0.5 }}>
            Student Slide<span style={{ color: "#4ecdc4" }}>!</span>
          </h1>
        </div>
          ...
          {["signup", "signin"].map((tab) => (
            <button
              ...
              style={{
                ...
                cursor: "pointer",
                fontFamily: "inherit",
                background: mode === tab ? "#7c5cbf" : "transparent",
                color: mode === tab ? "#fff" : "rgba(255,255,255,0.45)",
                boxShadow: mode === tab ? "0 2px 8px rgba(124,92,191,0.4)" : "none",
              }}
            >
        ...
        {mode === "signup" ? (
          <form onSubmit={handleSignUp} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              <div>
                ...
                <input style={inputStyle} placeholder="Please enter name" value={form.name} onChange={(e) => set("name", e.target.value)} />
              </div>
              <div>
                <label style={labelStyle}>Student Surname</label>
                <input style={inputStyle} placeholder="Please enter surname" value={form.surname} onChange={(e) => set("surname", e.target.value)} />
              </div>
            </div>

            <div>
              <label style={labelStyle}>Student Email</label>
              <input style={inputStyle} type="email" placeholder="Please enter email" value={form.email} onChange={(e) => set("email", e.target.value)} />
            </div>
            ...
            <div>
              ...
              <input style={inputStyle} type="password" placeholder="••••••••" value={form.confirm} onChange={(e) => set("confirm", e.target.value)} />
            </div>
            ...
            <button type="submit" className="ss-btn" disabled={loading} style={{
              ...
              background: "linear-gradient(135deg, #7c5cbf, #4ecdc4)",
            ...
            <p style={{ textAlign: "center", margin: 0, color: "rgba(255,255,255,0.45)", fontSize: 13 }}>
              ...
              <span onClick={() => setMode("signin")} style={{ color: "#4ecdc4", fontWeight: 700, cursor: "pointer" }}>
                Sign In
              </span>
            </p>
          </form>
          ...
          <form onSubmit={handleSignIn} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            <div>
              <label style={labelStyle}>Student Email</label>
              <input
                style={inputStyle} type="email" placeholder="Please enter email"
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
                ...
                <span style={{ color: "#4ecdc4", fontSize: 12, fontWeight: 700, cursor: "pointer" }}>Forgot?</span>
              </div>
              <input
            ...
            <p style={{ textAlign: "center", margin: 0, color: "rgba(255,255,255,0.45)", fontSize: 13 }}>
              ...
              <span onClick={() => setMode("signup")} style={{ color: "#4ecdc4", fontWeight: 700, cursor: "pointer" }}>
                Sign Up
              </span>
            </p>
          </form>
